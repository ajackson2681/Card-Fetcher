...
/**
 * Represents a single printing of one card. "Special" cards (transforming/meld cards, for
 * instance), will have one Card object for each state of the card.
 * 
...
public class Card {
  ...
  public Card(JSONObject cardData) {
    ...
    multiverseID = JSONUtil.getMultiverseData(cardData, "multiverse_ids");
  ...
  private static ArrayList<CardReference> getAllParts(JSONObject data, String key) {
    ...
    for (Object o : arr) {
      ...
      refs.add(
          new CardReference((String) j.get("name"), (String) j.get("uri"), (String) j.get("id")));
    }
    return refs;
  }
  ...
  /**
   * Returns a list of CardReference objects referencing all parts of a "special" multipart card.
   * This will include a reference to this card. Will be null if isMultiPart() == false.
   */
  ...
  /**
   * Returns true if the card is strictly legal in the given format, and false otherwise. NOTE:
  ...
  /**
   * Returns true if this card has multiple parts, and false otherwise. The other parts are
   * referenced in the list returned by getPartReferences().
   */
  ...
  /**
   * Returns true if this printing of the card is only available on MTGO, and false otherwise.
   */
  ...
  /**
   * Returns true if this card is "Time Shifted" from the past, and false otherwise.
   */
  ...
  /**
   * Returns true if this card is "Color Shifted" from another card, and false otherwise.
   */
  ...
  /**
   * Returns true if this card is "Future Shifted" from the future (spooky), and false otherwise.
   */
