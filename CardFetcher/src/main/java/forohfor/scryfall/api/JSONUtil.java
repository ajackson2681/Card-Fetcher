...
public class JSONUtil {
  ...
  public static Integer getMultiverseData(JSONObject data, String key) {
    JSONArray obj = (JSONArray) data.get(key);
    if ((obj != null) && (!obj.isEmpty())) {
      return Integer.valueOf(Integer.parseInt(obj.get(0).toString()));
    }
    return null;
  }
  ...
  public static Date getIsoDateData(JSONObject data, String key) {
    ...
    c.set(Integer.parseInt(isoSplit[0]), Integer.parseInt(isoSplit[1]),
