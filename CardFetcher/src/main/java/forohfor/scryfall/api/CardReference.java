...
/**
 * Represents a reference to a single printing of a card. Used for cards with multiple parts to
 * refer to the pages of the other parts.
 * 
...
public class CardReference {
  ...
  /**
   * Returns the card this object references. This is created by querying the API when first called
   * on this object. If there is no connection, will return null.
   */
  public Card getCard() {
    if (card == null) {
      try {
